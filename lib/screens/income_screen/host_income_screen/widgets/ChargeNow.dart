...
class ChargeNow extends StatelessWidget {
  ...
  TextEditingController amountController= TextEditingController();
   ChargeNow({Key? key,}) : super(key: key);
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: ()async{
                          if(amountController.text!=''&&idController.text!='')
                          {
                            await value.Charge(apiToken: 'Bearer '+(myApiToken??''), data: {'usd':amountController.text,
                            'receiver_id':idController.text}, context: context);

                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Stack(
                            ...
                            CircleAvatar(
                            backgroundImage:
                                NetworkImage(user?.data?.first.image ?? ''),
                          ...
                          CircleAvatar(
                            ...
                            child:Image(image: AssetImage('assets/images/shield.png'),)
                          ):user?.data![0].types!.forwarder == true ?
                          CircleAvatar(
                            backgroundImage:AssetImage('assets/images/dollar.png')
                          ...
                          CircleAvatar(
                            ...
                            :user?.data![0].types!.broadcaster == true?
                             CircleAvatar(
                               backgroundColor: Colors.white,
                            backgroundImage:AssetImage('assets/images/check-mark.png')
                            ):Container(),
                          ],
                          )
                        ),

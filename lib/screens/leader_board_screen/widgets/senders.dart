...
Widget senders(BuildContext context) {
  return Consumer<TopSenderProvider>(builder: (ctx, value, child) {
    ...
    return value.sender!= null ? Stack(
            children: [
              Container(
                    ...
                    children: [
                      Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              timeButton(title: 'daily'.tr, onPress: ()async{
                                await value.getSendGifts(token, 'today');
                              }),
                              timeButton(title: 'monthly'.tr, onPress: () async{
                                await value.getSendGifts(token, 'this_month');
                              }),
                              timeButton(title: 'yearly'.tr, onPress: () async{
                                await value.getSendGifts(token, 'this_year');

                              }),
                              timeButton(title: 'totally'.tr, onPress: () async{
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: topThree(
                                  ...
                                  level: '${value.sender?.data?.elementAt(2).user?.levelUser?.level}',
                              ...
                              InkWell(
                                ...
                                child: topThree(
                                  ...
                                  level: '${value.sender?.data?.elementAt(0).user?.levelUser?.level}',
                                  color: Colors.amber,
                                  height: 155,
                                  outRadius: 53,
                                  innerRadius: 50,
                              ...
                              InkWell(
                                ...
                                child: topThree(
                                  ...
                                  level: '${value.sender?.data?.elementAt(1).user?.levelUser?.level}',
                                  color: Colors.orange,
                                  height: 128,
                                  outRadius: 43,
                                  innerRadius: 40,
                          ...
                          if (value.sender!.data!.length > 3)
                            Container(
                              ...
                              child: ListView.separated(
                                itemBuilder: (context, index) => ListItemSender(index: 3 + index ,),
                                separatorBuilder: (context, index) => ListDivider(),
                                itemCount: min(value.sender!.data!.length-3, 47) ,
                              ),
                            ),
                        ],

...
Widget receivers(BuildContext context) {
  return Consumer<TopReceiverProvider>(builder: (ctx, value, child) {
    ...
    return value.receiver!=null ? Stack(
      children: [
        Container(
                              ...
                              value.receiver!.data!.length >= 3 ?
                                InkWell(
                                  ...
                                  child: topThree(
                                    ...
                                    level: '${value.receiver?.data?.elementAt(2).user?.levelUser?.level}',
                              ...
                              value.receiver!.data!.length >= 1 ?
                                InkWell(
                                  ...
                                  child: topThree(
                                    ...
                                    level: '${value.receiver?.data?.elementAt(0).user?.levelUser?.level}',
                                    color: Colors.amber,
                                    height: 155,
                                    outRadius: 53,
                                    innerRadius: 50,
                              ...
                              value.receiver!.data!.length >= 2 ?
                                InkWell(
                                  ...
                                  child: topThree(
                                    ...
                                    level: '${value.receiver?.data?.elementAt(1).user?.levelUser?.level}',
                                    color: Colors.orange,
                                    height: 128,
                                    outRadius: 43,
                                    innerRadius: 40,
                            ...
                            Container(
                              ...
                              child: ListView.separated(
                                itemBuilder: (context, index) =>
                                    ListItemReceiver(index: 3 + index ,),
                                separatorBuilder: (context, index) =>
                                    ListDivider(),
                                itemCount: value.receiver!.data!.length-3,
                              ),
                            ),
                        ],
                      )
